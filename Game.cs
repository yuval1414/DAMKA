...
namespace Ex02
{
    public class Game
    {
        ...
        private static bool s_AIPlaying = true;
        private static Player s_PlayerX = new Player(PawnType.X, null);
        private static Player s_PlayerO = new Player(PawnType.O, "AI");
        private static Player s_CurrentPlayer = s_PlayerX;
        ...
        public static void CreateNewGame()
        {
            ...
            while (true)
            {
                ...
                runGame();
                if (InputFromUser.DoYouWantAnotherGame())
                {
                    s_Board = new Board(s_Board.BoardSize, s_PlayerX.PawnList, s_PlayerO.PawnList);
                }
                else
                {
                    break;
